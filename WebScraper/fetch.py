...
async def scraping_card_data(tournament_name, card, session):
    ...
    if match_type_name == "Showmatch":
        ...
        extract_kills_stats(performance_stats_div, maps_id, team_mapping, player_to_team, missing_team, [tournament_name, stage_name, match_type_name, match_name, team_b])
        ...
        extract_economy_stats(eco_stats, eco_rounds_stats, maps_id, team_mapping, [tournament_name, stage_name, match_type_name, match_name, team_a, team_b])
