                ...
                for tr in stats_trs:
                    ...
                    for index, td in enumerate(filtered_tds):
                        ...
                        if class_name == "mod-player mod-a":
                            ...
                            agents = ""
                            player_agents_dict = players_agents.setdefault(player, set())
                            global_players_agents_dict = global_players_agents.setdefault(player, set())
                            if agent == "all" and len(players_agents[player]) > 1:
                                ...
                                for img in imgs:
                                    ...
                                    player_agents_dict.add(agent_name)
                                    agents += f"{agent}, "
                                agents = agents.strip(", ")
