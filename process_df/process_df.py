...
async def combine_drafts(file, year, dfs):
...
async def combine_eco_rounds(file, year, dfs):
...
async def combine_eco_stats(file, year, dfs):
...
async def combine_kills(file, year, dfs):
...
async def combine_kills_stats(file, year, dfs):
...
async def combine_maps_played(file, year, dfs):
...
async def combine_maps_scores(file, year, dfs):
...
async def combine_overview(file, year, dfs):
...
async def combine_rounds_kills(df, year, dfs):
...
async def combine_scores(file, year, dfs):
...
async def combine_win_loss_methods_count(file, year, dfs):
...
async def combine_win_loss_methods_round_number(file, year, dfs):
...
async def combine_agents_pick_rates(file, year, dfs):
...
async def combine_maps_stats(file, year, dfs):
...
async def combine_teams_picked_agents(file, year, dfs):
...
async def combine_players_stats(file, year, dfs):
